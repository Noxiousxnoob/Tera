...
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://nox:nox@nox.0erqdpv.mongodb.net/?retryWrites=true&w=majority")
...
TUT_VID = os.environ.get("TUT_VID", "https://t.me/NoxBots") # shareus ka tut_vid he 
